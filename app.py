...
qb_model_lasso = load('qb_lasso_model_new.pkl')
qb_model_ridge = load('qb_ridge_model_new.pkl')
qb_model_gb = load('qb_gb_model_new.pkl')
qb_model_knn = load('qb_knn_model_new.pkl')
